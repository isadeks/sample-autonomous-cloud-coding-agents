...
- **Trigger from Linear**: Apply a label to a Linear issue - see the [Linear integration setup guide](./LINEAR_SETUP_GUIDE.md), and the [recovery guide](./LINEAR_RECOVERY_GUIDE.md) for reading status reactions and replying when ABCA needs input
